...
| DEP-TEST-013 | Low | Dependencias/controles sin verificación automatizada visible. | REMEDIATED_REMOTE_VERIFIED | Sí; CDN exact-pinned con SRI, lockfile versionado, CI y Composer audit verificados remotamente. | Alpine/CDN y advisories pendientes de evidencia. | No. | Mantener vigilancia de dependencias y renovar hashes según cambios autorizados. |
