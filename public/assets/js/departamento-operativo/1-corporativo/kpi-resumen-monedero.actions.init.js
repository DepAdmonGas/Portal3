...
Alpine.data('kpiResumenMonederoComponent', () => ({
data: null,
cargando: true,
chartMensual: null,
chartAnual: null,
...
async cargarData() {
const c = document.getElementById('kpi-resumen-monedero-container');
const idYear = c ? parseInt(c.dataset.idYear) : 0;

try {
const res = await fetch('/departamento-operativo/resumen-monedero/kpi-evaluacion/data/' + idYear);
