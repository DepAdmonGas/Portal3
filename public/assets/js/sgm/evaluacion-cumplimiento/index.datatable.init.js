document.addEventListener('DOMContentLoaded', () => {
    ...
    table1 = $('#table-evaluacion-cumplimiento').DataTable({
        processing: true,
        serverSide: false,
        autoWidth: false,
        stateSave: true,
        ...
        ajax: {
            url: '/sgm/evaluacion-cumplimiento-objetivos-revision-direccion/datatable',
            type: 'GET',
                            ...
                            <ul class="dropdown-menu">
                                <li>
                                 ...
                                 <li>
                                    ...
                                    href="/sgm/evaluacion-cumplimiento-objetivos-revision-direccion/pdf/${row.id}" target="_blank">
    ...
    $("#table-evaluacion-cumplimiento tbody").on("click", "tr", function () {
