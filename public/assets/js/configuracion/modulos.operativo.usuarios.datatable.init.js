...
const table = $('#table-modulos-operativo-usuarios').DataTable({
processing: true,
serverSide: false,
autoWidth: false,
stateSave: true, 
...
{ title: 'Nombre del usuario', data: 'nombre' },
{
title: 'Estatus',
data: 'estatus',
width: '80px',
...
${disabled ? '' : ` 
@click='async () => {
const res = await goTo("/configuracion/modulos-operativo-usuarios/${row.id}");
}'
`}>
...
$("#table-modulos-operativo-usuarios tbody").on("click", "tr", function () {
