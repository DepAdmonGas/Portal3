...
Alpine.data('modulosPuestosOperativoForm', () => ({
...
init() {
window.modulosPuestoOperativoInstance = this;
...
model: 'modulo_id',
namespace: 'modulosPuestosOperativo',
options: {
...
let url = `/configuracion/modulos-operativo-puestos/modulo/${id}`;
if (currentId) {
url += `/${currentId}`;
}
...
let url = `/configuracion/submodulos-operativo-puestos/modulo/${moduloId}/puesto/${idPuesto}`;
...
const res = await fetch(`/configuracion/modulos-operativo-puestos/detalle/${id}`);
const data = await res.json();
...
let url = '/configuracion/modulos-operativo-puestos/create';

if (this.mode === 'edit') {
url = `/configuracion/modulos-operativo-puestos/update/${this.editId}`;
}
