...
const table = $('#table-submodulos-operativo').DataTable({
processing: true,
serverSide: false,
autoWidth: false,
stateSave: true,
...
ajax: {
url: '/configuracion/datatable-submodulos-operativo/idModulo/' + idModulo,
type: 'GET',
...
columns: [
{ title: '#', data: 'idSubmodulo', width: '60px', className: 'text-center align-middle' },
{ title: 'Nombre del Módulo', data: 'nombre', className: 'text-center align-middle'},
...
{ title: 'Estatus', data: 'estatus', width: '80px', className: 'text-center align-middle',
render: function (data) {
...
@click="async () => {
await deleteAction({
url: '/configuracion/delete-submodulos-operativo',
id: ${row.idSubmodulo},
name: '${row.nombre}',
...
$("#table-submodulos-operativo tbody").on("click", "tr", function () {
