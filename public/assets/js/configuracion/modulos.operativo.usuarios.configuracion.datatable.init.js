...
const table = $('#table-modulos-operativo-usuarios-configuracion').DataTable({
...
ajax: {
url: '/configuracion/datatable-modulos-operativo-usuarios/idUsuario/' + id,
type: 'GET',
...
columns: [
{ title: '#', data: 'idModuloUsuario', width: '60px', className: 'text-center align-middle' },
...
${!noEdit 
? ''
: `@click="window.modulosUsuarioOperativoInstance .openEditar(${row.idModuloUsuario})"'` 
}>
...
: `@click="async () => {
await deleteAction({
url: '/configuracion/modulos-operativo-usuarios/delete',
id: ${row.idModuloUsuario},
...
$("#table-modulos-operativo-usuarios-configuracion tbody").on("click", "tr", function () {
