...
const table = $('#table-modulos-usuarios').DataTable({
processing: true,
serverSide: false,
autoWidth: false,
stateSave: true, 
...
${disabled ? '' : ` 
@click='async () => {
const res = await goTo("/configuracion/modulos-usuarios/${row.id}");
}'
`}>
...
$("#table-modulos-usuarios tbody").on("click", "tr", function () {
