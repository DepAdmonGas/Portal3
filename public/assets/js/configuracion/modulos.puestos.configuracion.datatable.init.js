...
const table = $('#table-modulos-puestos-configuracion').DataTable({
...
ajax: {
url: '/configuracion/datatable-modulos-puestos/idPuesto/' + id,
type: 'GET',
...
${!noEdit 
? ''
: `@click="window.modulosPuestoInstance.openEditar(${row.idModuloPuesto})"'` 
}>
...
: `@click="async () => {
await deleteAction({
url: '/configuracion/modulos-puestos/delete',
id: ${row.idModuloPuesto},
name: '${row.idModuloPuesto}',
...
$("#table-modulos-puestos-configuracion tbody").on("click", "tr", function () {
