...
const table = $('#table-modulos-usuarios-configuracion').DataTable({
...
ajax: {
url: '/configuracion/datatable-modulos-usuarios/idUsuario/' + id,
type: 'GET',
...
const { noEdit, noDelete } = row.permisos;
...
: `@click="async () => {
await deleteAction({
url: '/configuracion/modulos-usuarios/delete',
id: ${row.idModuloUsuario},
name: '${row.idModuloUsuario}',
table: '#table-modulos-usuarios-configuracion'
});
}"`
}>
...
$("#table-modulos-usuarios-configuracion tbody").on("click", "tr", function () {
