...
if ($path === '/__test/login-a-no-sgm') { Auth::forget(); Session::set('usuario', ['id' => 1, 'id_estacion' => 101, 'nombre_estacion' => 'Tenant A', 'razonsocial' => 'A SA', 'multiestacion' => true]); Session::set('module_context', ['sgm' => ['id_estacion' => 101, 'id_depto' => null]]); $_SESSION['permisos'] = ['sasisopa' => ['descargar' => 1]]; exit('ok'); }
