      ...
      <div class="ms-auto">
       ...
       <div class="dropdown dropstart">
            ...
            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
              ...
              <li>
                <a class="dropdown-item" href="javascript:void(0)"><i class="ti ti-file"></i> Mejores Prácticas y Estándares</a>
              </li>
            </ul>
          </div>   
    ...
    <div class="table-responsive">
      <table id="table-lista-comprobacion" class="table table-striped table-bordered mb-0 text-nowrap align-middle">
        <thead>
          <tr>
          <th>#</th>
          <th>Norma, acuerdo, disposición</th>
      ...
      <div class="ms-auto">
        ...
        <div class="dropdown dropstart">
            ...
            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
              ...
              <li>
                <a class="dropdown-item" href="javascript:void(0)"><i class="ti ti-file"></i> Requisitos Legales SASISOPA</a>
              </li>
            </ul>
          </div>   
