...
<div class="card mt-4">
  ...
  <div class="d-flex align-items-center">
    <h4 class="card-title mb-0">Objetivos generales</h4>
      <div class="ms-auto">
  ...
  <ul>
    <li>Implementar los 11 procedimientos del Sistema de Gestión de medición en la estación de Servicio durante 2024 para la correcta cuantificación de petrolíferos.</li>
