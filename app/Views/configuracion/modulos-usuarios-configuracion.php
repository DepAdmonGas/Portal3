<div id="container" class="mt-4 mb-4" x-data="{ ...actions(), ...modulosUsuariosForm()}" data-id="<?=$idUsuario?>" >
...
<table id="table-modulos-usuarios-configuracion" class="table table-striped table-bordered mb-0 text-nowrap align-middle">
<tbody></tbody>
</table>
</div>
</div> 
...
<!---------- MODAL NUEVO / EDITAR ---------->
<div class="modal fade" id="nuevo" x-ref="modalNuevo" x-init="getModulos()" tabindex="-1">
