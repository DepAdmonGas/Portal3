<div id="container" class="mt-4 mb-4" data-id="<?=$idModulo?>">
...
<table id="table-submodulos-operativo" class="table table-striped table-bordered mb-0 text-nowrap align-middle">
<tbody></tbody>
</table>
</div>
</div> 
...
x-data="{ ...actions(), ...submoduloOperativoForm() }" @open-edit.window="openEdit($event.detail)">
...
<!-- NOMBRE MODULO -->
<label class="form-label">* Nombre del submódulo:</label>
<input type="text" class="form-control mb-3" x-model="nombre_submodulo" @input="errors.nombre_submodulo = false" :class="errors.nombre_submodulo ? 'is-invalid' : ''">
