<div id="container" class="mt-4 mb-4" x-data="{ ...actions(), ...modulosPuestosForm()}" data-id="<?=$idPuesto?>" >
...
<table id="table-modulos-puestos-configuracion" class="table table-striped table-bordered mb-0 text-nowrap align-middle">
<tbody></tbody>
</table>
</div>
</div> 
