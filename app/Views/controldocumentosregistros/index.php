      ...
      <div class="card-body">
        <h4 class="card-title text-center">Control y documentos de Requisitos Legales</h4>
         ...
         <div class="text-end mt-4">
          ...
          href="/sasisopa/control-documentos-registros/requisitos-legales">
            <i class="ti ti-eye"></i>
    ...
    <div class="card w-100">
      <div class="card-body">
        <h4 class="card-title text-center">Control y documentos del Sistema de Administración</h4>
          ...
          <div class="text-end mt-4">
          <a type="button" class="btn waves-effect waves-light btn-rounded bg-info-subtle text-info" 
          href="/sasisopa/control-documentos-registros/sistema-administracion">
            <i class="ti ti-eye"></i>
            Ver control y documentos
          </a>
        </div>
