...
<head>
    ...
    <!-- Alpine + Axios -->
    <script defer src="https://unpkg.com/alpinejs@3.17.3/dist/cdn.min.js"></script>
...
<body class="link-sidebar">
    ...
    <div id="main-wrapper">
        ...
        <span class="badge rounded bg-primary text-black d-flex align-items-center justify-content-center rounded-pill fs-1 fw-bolder">' . $pendientes['sgm'] . '</span>
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link" href="<?= $doc_sgm['archivo'] ?>" aria-expanded="false" download>
                            <span>
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link" href="<?= $doc_mpsgm['archivo'] ?>" aria-expanded="false" download>
                            <span>
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link" href="/sgm/cursos" aria-expanded="false">
                            <span>
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link" href="/personal/SGM" aria-expanded="false">
                            <span>
