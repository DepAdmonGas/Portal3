                                    ...
                                    <template
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center" width="48px">
                                                ...
                                                <div class="dropcen">
                                                    <a class="pointer" id="dropdownMenuButton" data-bs-toggle="dropdown" aria-expanded="false">
                                                        ...
                                                        <div class="dropcen">
                                                            ...
                                                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                                <li>
                                                                    <a class="dropdown-item pointer d-flex align-items-center gap-3" @click="editarProtocolo(item)"><i class="ti ti-edit fs-4"></i> Editar</a>

                                                                </li>
                                                                <li>
                                                                    <a class="dropdown-item pointer d-flex align-items-center gap-3" @click="eliminarProtocolo(item.id)"><i class="ti ti-trash fs-4"></i> Eliminar</a>
            ...
            <div class="col-md-4 mb-4">
                <div @click="abrirModalTelefonos()"
                    ...
                    <div class="card-body pb-4 p-4 pb-0 mb-0 d-flex flex-column justify-content-between">
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <div class="rounded-circle bg-primary text-white fw-bold d-flex align-items-center justify-content-center flex-shrink-0"
                                ...
                                <i class="ti ti-phone-call text-white display-6"></i>
                            </div>
                    ...
                    <div class="card-footer bg-transparent border-top border-light px-4 py-3 d-flex align-items-center justify-content-between text-primary fw-semibold mt-auto">
                        <span class="small">Ver teléfonos</span>
                ...
                <div class="d-flex align-items-center">
                    <div class="ms-auto">
                        <div class="dropdown dropcenter">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                <li>
                                    <a class="dropdown-item pointer" @click="nuevoPrograma()"><i class="ti ti-plus"></i> Nuevo</a>
                                </li>
                                <li>
                                    <a class="dropdown-item pointer" @click="openBuscarModal()"><i class="ti ti-search"></i> Buscar</a>
                                </li>
                                <li>
                        ...
                        <h4 class="modal-title text-white">
                            ...
                            <template x-if="modoProtocolo === 'create'">
                                <span class="d-inline-flex align-items-center">
                                    ...
                                    Nuevo protocolo de respuesta a emergencias
                                </span>
                            </template>
                                ...
                                <template
                                    ...
                                    <tr>
                                        ...
                                        <td
                                            ...
                                            <a class="pointer" @click="eliminarAnexo(item.id)"><i class="ti ti-trash fs-7 text-danger"></i></a>
                            ...
                            <div class="table-responsive mt-3 overflow-x-auto overflow-hidden">
                                ...
                                <table class="table table-bordered table-striped align-middle">
                                    ...
                                    <thead>
                                        ...
                                        <tr>
                                            <th class="text-start align-middle">Servicio de emergencia</th>
                                            <th class="text-center align-middle">Teléfono</th>
                                            <th class="text-center align-middle" width="48px"><i class="ti ti-edit fs-7 text-primary"></i></th>
                                            <th class="text-center align-middle" width="48px"><i class="ti ti-trash fs-7 text-danger"></i> </th>
                                        </tr>
