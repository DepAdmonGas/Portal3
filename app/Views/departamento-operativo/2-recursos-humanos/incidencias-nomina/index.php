        ...
        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 mb-2 text-end">
            ...
            <div class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                    ...
                    <li>
                        <a class="dropdown-item pointer" @click="descargarReporteEstaciones()">
                            <i class="ti ti-gas-station me-2"></i>Reporte de Estaciones
                        </a>
                    </li>
                    <li x-show="estacionEspecifica" x-cloak>
                        <a class="dropdown-item pointer" @click="descargarReporteIndividual()">
                    ...
                    <li>
                        <h6 class="dropdown-header">Módulos</h6>
                    </li>
