    ...
    <div class="mt-3" id="dd-section-cards">
        <div class="row justify-content-center">
            ...
            <div class="col-lg-4 col-md-6 col-12 mb-3">
                <a class="pointer" class="text-decoration-none" @click="showEstaciones()">
...
-->
            ...
            <div class="col-lg-4 col-md-6 col-12 mb-3">
                <a class="pointer" class="text-decoration-none" @click="showDireccion()">
                    <div class="card body-container-do overflow-hidden card-hover shadow-sm">
                        <div class="d-flex flex-row align-items-center">
                            <div class="icon-container-do">
        ...
        <div class="row mb-3 align-items-end g-3">
            ...
            <div class="col-md-6">
                <div class="d-flex align-items-center justify-content-md-end gap-2 flex-wrap">
                    ...
                    <a class="pointer" id="btn-dd-pdf-estaciones" class="btn btn-success d-inline-flex align-items-center">
