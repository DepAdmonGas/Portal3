                            ...
                            <table id="tabla-directorio" class="table table-striped table-bordered mb-0 text-nowrap align-middle">
                                ...
                                <tbody>
                                    <template x-if="directorio.length === 0">
                                        <tr>
                                            <td colspan="5" class="text-center text-muted"><small>No se encontró información para mostrar</small></td>
                                        </tr>
                                    </template>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <div class="dropdown dropstart">
                                                    <a class="pointer" data-bs-toggle="dropdown" class="text-decoration-none">
                        ...
                        <table id="tabla-facturas" class="table table-striped table-bordered mb-0 text-nowrap align-middle">
                            ...
                            <tbody>
                                ...
                                <template x-if="facturas.length === 0">
                                    <tr>
                                        <td colspan="3" class="text-center text-muted"><small>No se encontró información para mostrar</small></td>
                                    </tr>
                                </template>
                                ...
                                <template x-for="f in facturas" :key="f.id">
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <div class="dropdown dropstart">
                                                <a class="pointer" data-bs-toggle="dropdown" class="text-decoration-none"><i class="ti ti-dots-vertical fs-6"></i></a>
                                                <ul class="dropdown-menu">
                                                    <li>
                                                        <span x-data="actions()">
