...
<div class="row mt-4">
  ...
  <div class="col-md-4 d-flex align-items-stretch">
    <div class="card w-100">
      <div class="card-body">
        ...
        <a href="objetivos-metas-indicadores/capacitacion-personal">Capacitación del personal</a>
        </div>
  ...
  <div class="col-md-4 d-flex align-items-stretch">
    <div class="card w-100">
      <div class="card-body">
        <div class="fs-6 text-center">
          <a href="objetivos-metas-indicadores/experiencia-cliente">Experiencia del cliente</a>
        </div>
      </div>
    </div>
  </div>
   ...
   <div class="col-md-4 d-flex align-items-stretch">
    <div class="card w-100">
      <div class="card-body">
        <div class="fs-6 text-center">
          <a href="objetivos-metas-indicadores/indicador-ventas">Ventas</a>
        </div>
      </div>
    </div>
  </div>
