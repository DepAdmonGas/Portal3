...
<i class="ti" :class="mode ==='create' ? 'ti-message-plus' :'ti-edit'"></i>
...
<label class="form-label mb-1" x-text="evidencia.tema + ':'"></label>
...
<label x-text="(detalle.tema || 'Detalle comunicación').toUpperCase()"></label>
...
<div class="modal-header modal-colored-header bg-primary text-white">
<h4 class="modal-title text-white"> <i class="ti ti-search ms-2"></i>
Buscar</h4>
