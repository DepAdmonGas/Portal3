...
Configuracion de Modulos (Puestos) - <?=$puesto->tipo_puesto?>
</h4>
...
<li class="breadcrumb-item">Configuracion de Modulos (Puestos) - <?=$puesto->tipo_puesto?></li>
</ol>
</nav>
...
data-id-puesto="<?=$puesto->id ?>" x-data="moduloPuestoForm()">
<div class="modal-dialog modal-dialog-scrollable modal-lg">
<div class="modal-content">

<div class="modal-header bg-primary">
<h4 class="modal-title text-white">Agregar módulo (<?=$puesto->tipo_puesto?>)</h4>
...
data-id-puesto="<?=$puesto->id ?>" x-data="submoduloPuestoForm()">
<div class="modal-dialog modal-dialog-scrollable modal-md">
<div class="modal-content">

<div class="modal-header bg-primary">
<h5 class="modal-title text-white">Asignar submódulos (<?=$puesto->tipo_puesto?>)</h5>
<button type="button"class="btn-close btn-close-white" data-bs-dismiss="modal" @click="resetForm()"></button>
</div>
...
<div class="modal fade" id="modalEditarPermisos" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false" x-data="permisosForm()"
...
<div class="modal-header bg-primary">
<h5 class="modal-title text-white">Editar permisos del módulo / submódulo</h5>
<button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" @click="resetForm()"></button>
</div>
