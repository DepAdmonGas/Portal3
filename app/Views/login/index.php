...
<label class="form-check-label text-dark fs-3" for="flexCheckChecked">Recordar este usuario</label>
</div>
</div>
...
<span class="spinner-border spinner-border-sm"></span>Cargando...</span>
</template>
</button>
...
<img src="<?=asset('images/desing-photo-estaciones/img-login.png')?>" alt="Gasolinera_G500" class="w-100 h-100 object-fit-cover">
</div>
</div>
