...
class SgmEstructuraController extends BaseController{
    ...
    $permisos = ModuloService::permisosSesion($this->modulo);
        ...
        $data = [
            ...
            'scripts' => [
                ...
                '/js/sgm/estructura/index.action.init.js?v=1.0',
                '/js/asistencia/listaasistencia.actions.init.js?v=1.1',
                '/js/asistencia/listaasistencia.datatable.init.js?v=1.1',                
                '/js/sgm/estructura/revisionsgm.datatable.init.js?v=1.4'
            ],
            'help' => true
        ];
    ...
    public function datatableRevision(){
   ...
   Capsule::transaction(function () use ($id) {
    ...
    Breadcrumb::add('Home', '/home');
    Breadcrumb::add('SGM', '/sgm');
    Breadcrumb::add('1. Estructura del sistema de Medicion', '/sgm/estructura-sistema-medicion');
    Breadcrumb::add($title, '');
    $permisos = ModuloService::permisosSesion($this->modulo);
        ...
        $data = [
            ...
            'scripts' => [
                '/js/vendor.min.js',
                '/js/sgm/estructura/revision.action.init.js?v=1.0',
            ],
            'help' => false
        ];
        
        View::render('sgm/estructura/revision', $data,'sgm');
