...
class FormatoSgm14
{
    public function generar(int $idestacion, int $year): string
    {
        ...
        $contenido .= '<td rowspan="2" align="center" valign="middle">';
        $contenido .= '<b>Programa anual de calibración de patrones e instrumentos de medida</b>';
        $contenido .= '</td>';
    ...
    private function contenidoTabla(
         ...
         * Código original:
         *
         * sgm_programa_anual_calibracion_verificacion
        ...
        foreach ($registros as $registro) {
            ...
            $contenido .= '<td>';
            $contenido .= $this->e($registro->nombre . $detalleEquipo);
            $contenido .= '</td>';
